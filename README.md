...
5.Load the Input Image: Use OpenCV to read an input image containing one or more faces.

6.Preprocessing: Convert the input image to grayscale using GPU functions to simplify the computation. Apply histogram equalization if needed to improve contrast.

7.Face Detection Kernel: Load the Haar Cascade classifier for face detection. Launch CUDA kernels to perform convolution and filtering operations (edge detection, region extraction).
...
Output:
<img width="304" height="473" alt="image" src="https://github.com/user-attachments/assets/c7c8bd26-6bdd-44b5-96f6-f1058b9764ca" />
